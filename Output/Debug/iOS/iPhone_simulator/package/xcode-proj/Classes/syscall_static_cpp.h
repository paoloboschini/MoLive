...
inline void SYSCALL(maConnReadFrom) (int conn, int dst, int size, int src) {
	SYSCALL_IMPL(maConnReadFrom)(convertSingleArg<MAHandle>(conn), convertPointerArg<void*>(dst), convertSingleArg<int>(size), convertPointerArg<MAConnAddr*>(src));
}
inline void SYSCALL(maConnWriteTo) (int conn, int src, int size, int dst) {
	SYSCALL_IMPL(maConnWriteTo)(convertSingleArg<MAHandle>(conn), convertPointerArg<void*>(src), convertSingleArg<int>(size), convertPointerArg<MAConnAddr*>(dst));
}

 ...
 */
#define MAIDL_HASH ((int)0xdf2bd0ed)
...
#pragma pack(pop)
#endif
typedef struct MAConnAddrInet6Native {
	int port;
	byte addr[16];
} MAConnAddrInet6Native;
...
maIOCtl_maSaveImageToDeviceGallery_case(maSaveImageToDeviceGallery) \
...
maIOCtl_maCameraSnapshotAsync_case(maCameraSnapshotAsync) \
...
maIOCtl_syscall_case(maSaveImageToDeviceGallery) \
...
maIOCtl_syscall_case(maCameraSnapshotAsync) \
...
#define maIOCtl_maSaveImageToDeviceGallery 61
#define maIOCtl_maSaveImageToDeviceGallery_case(func) \
case 61: \
{ \
MAHandle _imageHandle = (MAHandle)a; \
const char* _imageName = GVS(b); \
return func(_imageHandle, _imageName); \
} \

#define maIOCtl_maSendTextSMS 62
...
#define maIOCtl_maFrameBufferGetInfo 80
...
#define maIOCtl_maFrameBufferInit 81
...
#define maIOCtl_maFrameBufferClose 82
...
#define maIOCtl_maSendToBackground 87
...
#define maIOCtl_maBringToForeground 88
...
#define maIOCtl_maGetSystemProperty 90
...
#define maIOCtl_maIapShutdown 93
...
#define maIOCtl_maNetworkStatus 94
...
#define maIOCtl_maIapSetMethod 95
...
#define maIOCtl_maIapSetFilter 96
...
#define maIOCtl_maCameraFormatNumber 129
...
#define maIOCtl_maCameraFormat 130
...
#define maIOCtl_maCameraStart 131
...
#define maIOCtl_maCameraStop 132
...
#define maIOCtl_maCameraSetPreview 133
...
#define maIOCtl_maCameraSelect 134
...
#define maIOCtl_maCameraNumber 135
...
#define maIOCtl_maCameraSnapshot 136
...
#define maIOCtl_maCameraSnapshotAsync 137
#define maIOCtl_maCameraSnapshotAsync_case(func) \
case 137: \
{ \
MAHandle _dataPlaceholder = (MAHandle)a; \
int _sizeIndex = b; \
return func(_dataPlaceholder, _sizeIndex); \
} \

#define maIOCtl_maCameraRecord 138
...
#define maIOCtl_maCameraSetProperty 139
...
#define maIOCtl_maCameraGetProperty 140
...
#define maIOCtl_maCameraPreviewSize 141
...
#define maIOCtl_maCameraPreviewEventEnable 142
...
#define maIOCtl_maCameraPreviewEventDisable 143
...
#define maIOCtl_maCameraPreviewEventConsumed 144
...
#define maIOCtl_maShowVirtualKeyboard 145
...
#define maIOCtl_maKeyCaptureStart 147
...
#define maIOCtl_maKeyCaptureStop 148
...
#define maIOCtl_maHomeScreenEventsOn 149
...
#define maIOCtl_maHomeScreenEventsOff 150
...
#define maIOCtl_maHomeScreenShortcutAdd 151
...
#define maIOCtl_maHomeScreenShortcutRemove 152
...
#define maIOCtl_maNotificationAdd 153
...
#define maIOCtl_maNotificationRemove 154
...
#define maIOCtl_maScreenSetFullscreen 155
...
#define maIOCtl_maAutostartOn 156
...
#define maIOCtl_maAutostartOff 157
...
#define maIOCtl_maScreenStateEventsOn 158
...
#define maIOCtl_maScreenStateEventsOff 159
...
#define maIOCtl_maReportResourceInformation 409
...
#define maIOCtl_maMessageBox 410
...
#define maIOCtl_maToast 412
#define maIOCtl_maToast_case(func) \
case 412: \
{ \
const char* _message = GVS(a); \
int _duration = b; \
return func(_message, _duration); \
} \
...
#define maIOCtl_maScreenSetOrientation 524
...
#define maIOCtl_maScreenSetSupportedOrientations 525
...
#define maIOCtl_maScreenGetSupportedOrientations 526
...
#define maIOCtl_maScreenGetCurrentOrientation 527
